...
TARBALL_SHA256 = "9c7fc187d3d25ad9eec6a7fad88b0c64df519968cf3beb3439ef4d3764376166"
...
def test_release_formula_uses_verified_0_5_5_tag():
    release = Path("docs/release.md").read_text(encoding="utf-8")
    formula = Path("Formula/supa-cc.rb").read_text(encoding="utf-8")

    assert "v0.5.5" in formula
...
def test_release_runbook_orders_pypi_verification_before_formula_and_copy_changes():
    ...
    assert "v0.5.5" in Path("Formula/supa-cc.rb").read_text(encoding="utf-8")
