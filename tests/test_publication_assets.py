...
TARBALL_SHA256 = "a23f5f57d663cc5989b353e77475f7f0154116961c8d343257ff9d0cd28b0a49"
...
def test_release_formula_uses_verified_0_5_0_tag():
    release = Path("docs/release.md").read_text(encoding="utf-8")
    formula = Path("Formula/supa-cc.rb").read_text(encoding="utf-8")

    assert "v0.5.0" in formula
...
def test_release_runbook_orders_pypi_verification_before_formula_and_copy_changes():
    ...
    assert "v0.5.0" in Path("Formula/supa-cc.rb").read_text(encoding="utf-8")
