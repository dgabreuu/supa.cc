from supa_cc.ui.theme import COLOR_PRIMARY, OUTPUT_STYLES, QUESTIONARY_STYLE
...
def test_output_styles_use_primary_color_for_highlight_error_banner():
    assert "#00D388" in OUTPUT_STYLES["error"]
    assert "#00D388" in OUTPUT_STYLES["highlight"]
    assert "#00D388" in OUTPUT_STYLES["banner"]
