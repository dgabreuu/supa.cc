...
Supa.cc requires Python 3.11+ and the [official Supabase CLI](https://supabase.com/docs/guides/local-development/cli/getting-started) 2.109.1 or newer. The recommended path is the immutable `v0.5.2` bootstrap for your operating system.
...
```bash
curl -fsSL https://raw.githubusercontent.com/dgabreuu/supa.cc/v0.5.2/install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/dgabreuu/supa.cc/v0.5.2/install.ps1 | iex
```
